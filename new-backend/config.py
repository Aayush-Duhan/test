...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        max_self_heal_iterations=int(os.getenv("MAX_SELF_HEAL_ITERATIONS", "5")),
        scai_work_dir=os.getenv("SCAI_WORK_DIR", "./scai_projects"),
        ...
        sf_authenticator=os.getenv("SF_AUTHENTICATOR", "externalbrowser"),
    )
