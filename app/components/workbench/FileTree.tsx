  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-bolt-item-content-default hover:text-bolt-item-content-active hover:bg-bolt-item-bg-active':
          !selected,
        'bg-bolt-item-bg-accent text-bolt-item-content-accent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-bolt-item-bg-active text-bolt-item-content-default': !selected,
        'bg-bolt-item-bg-accent text-bolt-item-content-accent': selected,
      })}
      depth={depth}
      icon={<FileCode className={classNames('scale-98', {
        'group-hover:text-bolt-item-content-active': !selected,
      })} />}
      onClick={onClick}
    >
      <div
...
function NodeButton({ depth, iconClasses, icon, onClick, className, children }: ButtonProps) {
  return (
    <button
      ...
      onClick={() => onClick?.()}
    >
      {icon ? <span className={classNames('scale-120 shrink-0')}>{icon}</span> : <div className={classNames('scale-120 shrink-0', iconClasses)}></div>}
